export class Projectile {
    ...
    updateTrail() {
        ...
        this.trailPoints = this.trailPoints.filter((point) => currentTime - point.time < maxTrailAge);
    }
    ...
    checkBoundaries() {
        if (this.bounce && this.bounceCount < this.maxBounces) {
            ...
            if (
                this.x < bounds.left - 200 ||
                this.x > bounds.right + 200 ||
                this.y < bounds.top - 200 ||
                this.y > bounds.bottom + 200
            ) {
