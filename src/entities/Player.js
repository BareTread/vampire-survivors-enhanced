...
export class Player {
    ...
    celebrateComboMilestone(threshold) {
        ...
        if (this.game.systems.adaptiveMusic) {
            this.game.systems.adaptiveMusic.triggerMelodicFragment();
        }
    ...
    getEffectiveStats() {
        ...
        // PASSIVE ITEM BONUSES — from PassiveItemSystem
        const passiveItems = this.game.systems?.passiveItems;
        if (passiveItems) {
        ...
        // PERMANENT UPGRADES — from PersistenceSystem (cross-run meta-progression)
