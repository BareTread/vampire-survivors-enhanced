    ...
    _buildDefinitions() {
        return new Map([
            ['spinach', {
                ...
                icon: '🌿',
                stat: 'damage',
                description: 'Raises damage by 8%',
                upgradeDescription: level => `+${level * 8}% damage`,
                bonusPerLevel: 0.08,
                maxLevel: 5,
                color: '#4ade80'
            }],
            ['wings', {
                ...
                icon: '🪶',
                stat: 'speed',
                description: 'Raises speed by 8%',
                upgradeDescription: level => `+${level * 8}% speed`,
                bonusPerLevel: 0.08,
                maxLevel: 5,
                color: '#60a5fa'
            }],
            ['armor', {
                ...
                upgradeDescription: level => `-${level * 3} damage taken`,
                bonusPerLevel: 3,
                maxLevel: 5,
                color: '#a78bfa'
            }],
            ['empty_tome', {
                ...
                icon: '📖',
                stat: 'cooldown',
                description: 'Reduces weapon cooldowns by 6%',
                upgradeDescription: level => `-${level * 6}% cooldown`,
                bonusPerLevel: 0.06,
                maxLevel: 5,
                color: '#c084fc'
            }],
